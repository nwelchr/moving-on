...
"use strict";
const levelMaps = [["  x                                                        ", "  x                    ", "  x                    ", "  x             v      ", "  x                    ", "  x                    ", "  x                    ", "  x                                              = ", "  x               x  x                    =x", "  x 12     xxxxxx   x  x                =x", "  x             =  x  x", "  xxxxx              ", "      x                                                 !     ", "      xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  ", "                      "], ["                      ", "                      ", "                     ", "                     ", "                      ", "                     ", "                      ", "                     ", "                      ", "                      ", "  x              = x  ", "  x 12              x  ", "  x         !   xx x  ", "  xxxxx    xx    = x  ", "      xxxxxxxxxxxxxx  ", "      xxxxxxxxxxxxxx  ", "                      "]];
